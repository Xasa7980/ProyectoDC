...
inline float ShaderExtensions_DynamicRadialMasks_Sonar_Advanced(float3 vertexWorldPosition, float noise, float3 maskPosition, float radius, float intensity, float noiseStrength, float edgeSize, int ringCount, float smooth)
{
